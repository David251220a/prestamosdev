...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            {!! Form::model($tasa, ['route' => ['tasas.update', $tasa], 'method' => 'put']) !!}
            ...
            <div class="row">
                ...
                <div class="form-group md-1 mt-1">
                    ...
                    <select name="activo" id="activo" class="form-control selectpicker"  data-live-search="true">                        
                        ...
                        <option value="1" @if(1 == $tasa->activo) selected="selected" @endif>ACTIVO</option>
                        <option value="0" @if(0 == $tasa->activo) selected="selected" @endif>INACTIVO</option>
