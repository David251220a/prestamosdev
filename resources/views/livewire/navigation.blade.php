            ...
            <div class="hidden sm:block sm:ml-6">
                ...
                <div class="flex space-x-4">
                    ...
                    {{-- @foreach ($categoria as $cate)
                        ...
                        <a href=" {{ route('posts.categoria', $cate) }}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">{{$cate->name}}</a>
        ...
        @auth
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <div x-data="{ open : false }" class="ml-3 relative" >
                    <div>
                        <button @click="open = true" type="button" class="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                            {{-- Open user menu --}}
                            <span class="sr-only"></span>
    ...
    <div class="sm:hidden" id="mobile-menu" x-show="open" @click.away="open = false">
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            {{-- @foreach ($categoria as $cate)
                ...
                <a href="{{ route('posts.categoria', $cate) }}" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">{{$cate->name}}</a>
